...
def evaluate(net, val_dataloader):
    ...
    print("[epoch: %3d/%3d, ite: %d] val loss: %3f, tar: %3f " % (
    epoch + 1, epoch_num, ite_num, val_loss, val_tar_loss))
...
train_dataset = PatSegDataset(anno_file, frame_root, 
                   transform=transforms.Compose([
                       RescaleT(320),
                       RandomCrop(288),
                       ToTensorLab(flag=0)]), split_='train')
val_dataset = PatSegDataset(anno_file, frame_root, 
